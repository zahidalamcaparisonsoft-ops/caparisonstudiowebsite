...
const FIELDS: Field[] = [
  { key: "title", label: "Title", type: "text", summary: true, seed: "New project" },
  {
    key: "slug",
    label: "Slug",
    type: "text",
    help: "Used in the case-study URL. Must be unique.",
    uniqueSeed: "new-project",
  },
  ...
  { key: "published", label: "Published", type: "bool", seed: true },
